package lk.ijse.shaili.system.Service.util;


import lk.ijse.shaili.system.Dto.*;
...
public class Converter {
    ...
    public CustomerDTO fromCustomer(Customer customer){
        return new CustomerDTO(customer.getCid(),customer.getName(),customer.getAddress(),customer.getContact(),customer.getNic());
    }

    public Customer toCustomer(CustomerDTO customerDTO){
        return new Customer(customerDTO.getCid(),customerDTO.getName(), customerDTO.getAddress(), customerDTO.getContact(), customerDTO.getNic());
    }
